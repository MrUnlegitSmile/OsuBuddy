...
public class Relax
{
	...
	private int holdTime = 45;

	private int alternateTime = 161;

	private int percentToHitOutsideOffset = 3;
	...
	public void Start(OsuBeatmap beatmap)
	{
		...
		int num = osu.HitWindow50(ac__DisplayClass18_.beatmap.OverallDifficulty) + 5;
		int num2 = osu.HitWindow50(ac__DisplayClass18_.beatmap.OverallDifficulty) + 5;
